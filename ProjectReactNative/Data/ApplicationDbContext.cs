...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Animal>(entity =>
        {
            ...
            entity.HasIndex(e => e.HabitatId, "IX_Animals_habitat_id");
        ...
        modelBuilder.Entity<EventStaff>(entity =>
        {
            ...
            entity.HasIndex(e => e.EventId, "IX_EventStaffs_event_id");

            entity.HasIndex(e => e.StaffId, "IX_EventStaffs_staff_id");
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            entity.HasIndex(e => e.RefId, "IX_Order_Items_product_id");
            ...
            entity.HasOne(d => d.Ref).WithMany(p => p.OrderItems)
                .HasForeignKey(d => d.RefId)
                .HasConstraintName("FK__Order_Ite__produ__6754599E");

            entity.HasOne(d => d.RefNavigation).WithMany(p => p.OrderItems)
                .HasForeignKey(d => d.RefId)
                .HasConstraintName("FK_Order_Items_Tickets");
        });
        ...
        modelBuilder.Entity<QrScanLog>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductId, "IX_QR_Scan_Logs_product_id");
        ...
        modelBuilder.Entity<Staff>(entity =>
        {
            ...
            entity.HasIndex(e => e.UserId, "IX_Staffs_user_id");
